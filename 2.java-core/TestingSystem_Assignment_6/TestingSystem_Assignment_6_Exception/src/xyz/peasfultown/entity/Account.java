...
public class Account {
	...
	public Account(String username) {
		this(String.format("%s@example.com", username), username, "Unknown Name", null, null, LocalDateTime.now(), new Group[0]);
	}
	
	public Account(String email, String username, String fullname) {
		this(email, username, fullname, null, null, LocalDateTime.now(), new Group[0]);
	}
	
	public Account(String email, String username, String fullname, Department department, Position position) {
		this(email, username, fullname, department, position, LocalDateTime.now(), new Group[0]);
	}
	
	public Account(String email, String username, String fullname, Department department, Position position, LocalDateTime createDate, Group[] groups) {
